					...
					<div className="w-1/2 max-lg:w-full flex gap-10">
						<div className="w-full flex flex-col gap-y-5 items-start">
							...
							<p className="text-gray-600 dark:text-gray-400 w-full text-left">
								It’s not just a system problem — outdated and
								complex tools hold your business back. They slow
								down growth, inflate operational costs, and
								drain efficiency. Instead of moving forward,
								your team spends more time fixing problems than
								creating opportunities.{" "}
								<span className=" font-semibold text-primary">
									It’s time to break the wall. Explore our
									services below and build the digital
									foundation your business truly deserves.
								</span>
							</p>
						</div>
					</div>
