						...
						<div className="w-full lg:w-5/12">
							<div className="animate-fadeInUp">
								...
								<div className="text-sm font-semibold mb-6 text-black dark:text-white">
									You have come all the way here, why don’t
									take the first step and send us an email?
									It’s free!
								</div>
								<div className="text-xs text-gray-700 dark:text-gray-300">
									<p>
										We offer a free, no pressure, no strings
										attached — just a friendly chat to help
										you understand what you need for your
										next step in the digital world. We’ll
										guide you with care so your business can
										grow with ease.
									</p>
								</div>
							</div>
