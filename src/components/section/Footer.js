        ...
        <footer className="bg-gradient-to-b from-black to-zinc-900  text-gray-300 py-12">
            <div className="container">
                ...
                <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    {/* Company Info */}
                    <div>
                        <p className="font-semibold text-white">PT Jembatan Digital Inovatif</p>
                        <address className="not-italic text-xs leading-relaxed mt-2">
                            ...
                            Phone:{" "}
                            <a href="tel:+62-813-82189198" className="text-primary hover:underline">
                                +62-813-82189198
                            </a>{" "}
                            <br />
                            Email:{" "}
                ...
                <div className="mt-10 border-t border-gray-700 pt-6 flex flex-col md:flex-row items-center justify-between text-xs">
                    ...
                    <p className="text-gray-400 text-center md:text-right">
                        Copyright © 2025 PT Jembatan Digital Inovatif. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
