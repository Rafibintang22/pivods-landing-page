...
export default function About() {
    return (
        <section
            id="About"
            className="relative w-full flex flex-col items-center justify-center text-center mt-20 pt-24"
        >
                        ...
                        <div className="w-full flex flex-col gap-y-5 items-start">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                                ...
                                <div className="text-center md:text-left">
                                    ...
                                    <p className="mt-2 text-white/60">Client Satisfaction Rate</p>
                                </div>
                                <div className="text-center md:text-left">
                                    <h2 className="text-3xl font-bold text-white">
                                        15
                                    ...
                                    <p className="mt-2 text-white/60">Global Business Partners</p>
                                </div>
                            </div>
                        </div>
                    </div>
