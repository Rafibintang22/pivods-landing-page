...
function CtaBanner({ ctaText, smallText }) {
	return (
		<div
			className={`w-full mt-16  ${layoutStyles.container} flex justify-between items-center max-lg:flex-col max-lg:gap-y-5`}
		>
			<div className="w-3/4 max-lg:w-full max-lg:text-center">
				...
				<p className="text-gray-600 text-[15px] lg dark:text-gray-400 w-full">
					...
					inefficiencies, and missed opportunities so your business
